		...
		<div class="flex h-16 items-center justify-between">
			...
			<div class="flex items-center gap-2">
				<a href={resolve('/')} class="flex items-center gap-2 group">
					<div class="flex h-9 w-9 items-center justify-center rounded-lg bg-linear-to-br from-neon-cyan to-neon-teal shadow-[0_0_15px_rgba(6,182,212,0.5)] transition-all group-hover:scale-105 group-hover:shadow-[0_0_20px_rgba(6,182,212,0.8)]">
