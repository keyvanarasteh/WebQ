...
<div class="w-full flex flex-col items-center py-12 space-y-12">
	...
	<div class="text-center max-w-2xl">
		<h1 class="text-4xl md:text-5xl font-extrabold tracking-tight text-white mb-4">
			{m.dl_hero_title_1()} <span class="text-transparent bg-clip-text bg-linear-to-r from-neon-cyan to-neon-teal">{m.dl_hero_title_2()}</span>
		</h1>
	...
	<div class="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl">
		{#each downloads as dl (dl.os)}
			<div class="relative flex flex-col rounded-2xl border bg-linear-to-br bg-obsidian p-8 transition-transform hover:-translate-y-1 {dl.color}">
				...
				<div class="mt-auto pt-6 border-t border-white/10">
					<a href="https://github.com/keyvanarasteh/WebQ/releases/latest" 
