...
<div class="bg-white/5 dark:bg-[#09090b] border border-gray-200 dark:border-[#27272a] rounded-xl p-6 shadow-sm">
  <h3 class="text-lg font-bold text-gray-900 dark:text-cyan-400 mb-4">Social Graph Maps</h3>
  ...
  {:else if data}
    <div class="grid grid-cols-1 gap-4">
        ...
        <div class="p-4 bg-gray-50 dark:bg-[#121214] border border-gray-200 dark:border-[#27272a] rounded-lg hover:border-cyan-500/50 transition-colors">
            <h4 class="text-xs font-bold text-gray-500 mb-3 uppercase tracking-wider">OpenGraph Tags</h4>
            <div class="space-y-2">
        ...
        <div class="p-4 bg-gray-50 dark:bg-[#121214] border border-gray-200 dark:border-[#27272a] rounded-lg border-l-4 {data.twitter_card ? 'border-l-blue-500' : 'border-l-red-500'}">
            <h4 class="text-xs font-bold text-gray-500 mb-2 uppercase tracking-wider">Twitter Architecture</h4>
            <p class="text-sm text-gray-900 dark:text-gray-300 font-mono">{data.twitter_card || 'Missing twitter:card tag'}</p>
        </div>
    </div>
  {:else}
