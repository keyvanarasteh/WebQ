            ...
            <div class="relative bg-linear-to-r from-indigo-950/40 via-purple-900/10 to-transparent p-6 border-b border-indigo-500/10 shrink-0">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative z-10">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold tracking-tight text-primary-text">{m.recon_contact_guide_title()}</h2>
                            <p class="text-sm text-muted mt-1 max-w-md">{m.recon_contact_guide_desc()}</p>
                        </div>
                    </div>
            ...
            <div class="flex-1 overflow-y-auto p-6 relative">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div class="bg-glass border border-subtle rounded-xl p-6 relative overflow-hidden shadow-inner h-full flex flex-col justify-center">
                                ...
                                <div class="relative z-10 space-y-4">
                                    ...
                                    <div class="flex items-center gap-3 bg-surface/80 p-3 rounded-lg border border-indigo-500/30 shadow-[0_0_15px_rgba(79,70,229,0.15)] backdrop-blur ml-6">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-muted">Pattern match: (FirstInitial.LastName)</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 bg-surface/80 p-3 rounded-lg border border-rose-500/30 shadow-[0_0_15px_rgba(244,63,94,0.15)] backdrop-blur ml-12">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-muted">Found in leaked resume PDF</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                {:else if activeTab === 1}
                    <div transition:fade={{duration: 200}}>
                        ...
                        <p class="text-sm text-muted mb-6 max-w-3xl">Once the human infrastructure is mapped, attackers weaponize the data. Humans are historically the weakest link in any perimeter.</p>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                            <div class="bg-indigo-950/20 border border-indigo-500/20 rounded-xl p-5 hover:bg-indigo-900/20 transition-colors">
                                ...
                                <p class="text-xs text-muted leading-relaxed">Targeting executives or IT admins with highly tailored emails referencing internal projects (found via social media) to inject malware or steal MFA tokens.</p>
                            </div>
                            <div class="bg-purple-950/20 border border-purple-500/20 rounded-xl p-5 hover:bg-purple-900/20 transition-colors">
                                ...
                                <p class="text-xs text-muted leading-relaxed">Using the harvested email list, attackers try common passwords (e.g., `Company2024!`) across all accounts slowly to avoid account lockout policies.</p>
                            </div>
                            <div class="bg-rose-950/20 border border-rose-500/20 rounded-xl p-5 hover:bg-rose-900/20 transition-colors">
                                ...
                                <p class="text-xs text-muted leading-relaxed">Calling the IT Helpdesk pretending to be a specific exposed employee who "lost their phone" to get an MFA device reset or password change.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative bg-[#0d1117] rounded-xl border border-indigo-500/30 overflow-hidden font-mono text-sm shadow-[0_0_20px_rgba(99,102,241,0.1)]">
                            ...
                            <div class="p-4 overflow-x-auto pt-10 text-muted custom-scrollbar">
                                ...
                                <p class="text-muted text-[10px] mt-2">[DATA] 150 emails loaded. Starting attack...</p>
                ...
                {:else if activeTab === 2}
                    <div transition:fade={{duration: 200}}>
                        ...
                        <p class="text-sm text-muted mb-6 max-w-3xl">You cannot hide every employee, but you can severely limit the blast radius of OSINT harvesting and social engineering.</p>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="bg-sunken border border-base p-5 rounded-xl">
                                    ...
                                    <p class="text-xs text-muted leading-relaxed">Train high-value targets (Executives, Finance) to recognize urgency-based pretexting. Remove public PDF directories that leak metadata.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-[#0A0C10] p-4 border-t border-indigo-500/10 flex items-center justify-between shrink-0 shadow-[0_-10px_20px_-10px_rgba(0,0,0,0.5)] z-20">
                ...
                <div class="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
                    ...
                    {#if activeTab < tabs.length - 1}
                        <button 
                            onclick={nextTab}
                            class="flex items-center gap-1.5 px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-primary-text text-sm font-semibold rounded-xl shadow-[0_0_20px_rgba(99,102,241,0.4)] transition-all transform hover:scale-105 active:scale-95 focus:ring-2 focus:ring-indigo-500/50 outline-none"
                        >
