                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative z-10">
                    <div class="flex items-center gap-4">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-600/10 flex items-center justify-center border border-cyan-500/30 shadow-inner">
                            <ListChecks size={28} class="text-cyan-400" />
                        </div>
                        <div>
                            <h2 class="text-2xl font-bold tracking-tight text-white">{m.recon_validator_title ? m.recon_validator_title() : 'Bulk Validation & Live Recon'}</h2>
                            <p class="text-sm text-zinc-400 mt-1 max-w-md">Attack Surface Management through endpoint verification.</p>
                        </div>
                    </div>
            ...
            <div class="flex-1 overflow-y-auto p-6 relative">
                {#if activeTab === 0}
                    <div transition:fade={{duration: 200}}>
                        ...
                        <p class="text-sm text-zinc-400 mb-8 max-w-3xl leading-relaxed">
                        ...
                        <div class="bg-gradient-to-r from-blue-900/20 to-transparent border-l-4 border-blue-500 p-6 rounded-r-xl shadow-lg">
                ...
                {:else if activeTab === 1}
                    <div transition:fade={{duration: 200}}>
                        ...
                        <p class="text-sm text-gray-400 mb-6 max-w-3xl">Active probing operates hierarchically across several protocols.</p>
                        
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="bg-[#121214] border border-[#27272a] p-6 rounded-xl flex flex-col items-center text-center shadow-lg hover:border-purple-500/30 transition-colors">
                                ...
                                <h4 class="font-bold text-gray-200 text-base mb-3">DNS Resolution</h4>
                                <p class="text-xs text-gray-400 leading-relaxed">Detects if the domain resolves to an IP. A missing DNS record but present subdomain in a bruteforce list might indicate a potential Subdomain Takeover vector.</p>
                            </div>

                            <div class="bg-[#121214] border border-[#27272a] p-6 rounded-xl flex flex-col items-center text-center shadow-lg hover:border-blue-500/30 transition-colors">
                                ...
                                <h4 class="font-bold text-gray-200 text-base mb-3">Port 80 (HTTP)</h4>
                                <p class="text-xs text-gray-400 leading-relaxed">Unencrypted web traffic. Modern sites should immediately 301 redirect this to HTTPS. A 200 OK on Port 80 without redirection is an instant security audit flag.</p>
                            </div>

                            <div class="bg-[#121214] border border-[#27272a] p-6 rounded-xl flex flex-col items-center text-center shadow-lg hover:border-green-500/30 transition-colors">
                                ...
                                <h4 class="font-bold text-gray-200 text-base mb-3">Port 443 (HTTPS)</h4>
                                <p class="text-xs text-gray-400 leading-relaxed">Secure web traffic. Successful connection indicates an active service and SSL certificate deployment, meaning the endpoint is a live target for deep scanning.</p>
                            </div>
                        </div>
                    </div>
                {:else if activeTab === 2}
                    <div transition:fade={{duration: 200}}>
                        ...
                        <p class="text-sm text-zinc-400 mb-6 max-w-3xl leading-relaxed">Understanding the funneling phase of a penetration test or bounty hunting session.</p>
                        ...
                        <div class="bg-black/40 border border-emerald-500/20 rounded-xl p-8 shadow-inner relative overflow-hidden">
                            ...
                            <div class="flex flex-col gap-6 relative z-10">
                                <div class="flex items-center gap-4">
                                    <div class="bg-zinc-800 text-zinc-300 font-mono text-xs px-3 py-1 rounded border border-zinc-700">10,000+</div>
                                    <p class="text-sm text-gray-300"><strong>Subdomain Scraping:</strong> Tools like Amass and Subfinder pull raw, noisy permutations from public sources.</p>
                                </div>
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <p class="text-sm text-gray-300"><strong>HTTPX / Validator:</strong> Pings all domains on P80/443 async to filter out dead space.</p>
                                </div>
                                <div class="w-0.5 h-6 bg-emerald-500/30 ml-8"></div>
