...
{#if isOpen}
    ...
    >
        ...
        >
            <!-- Header Area -->
            <div class="relative bg-gradient-to-r from-blue-950/40 via-indigo-900/10 to-transparent p-6 border-b border-blue-500/10 shrink-0">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative z-10">
                    <div class="flex items-center gap-4">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500/20 to-indigo-600/10 flex items-center justify-center border border-blue-500/30 shadow-inner">
