...
{#if isLoading && !results}
	<div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start h-full pb-8">
		...
		<div class="lg:col-span-4 bg-[#18181b] border border-[#27272a] rounded-lg p-6 animate-pulse w-full">
			<div class="h-6 w-32 bg-[#27272a] rounded mb-6"></div>
			<div class="space-y-4">
				{#each Array(4) as _, j (j)}
					<div class="h-10 w-full bg-[#27272a] rounded"></div>
...
{:else}
	<div class="flex flex-col items-center justify-center py-20 text-slate-500 border border-dashed border-[#27272a] rounded-lg bg-[#18181b]/50 shadow-inner">
