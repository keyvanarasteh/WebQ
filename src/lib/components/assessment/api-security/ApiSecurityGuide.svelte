                            ...
                            <div class="bg-glass border border-subtle rounded-xl p-6 flex flex-col items-center justify-center relative shadow-inner h-full">
                                <div class="flex items-center justify-between w-full mb-6 relative py-4">
                                    <div class="flex flex-col items-center z-10 w-20">
                                        <div class="w-12 h-12 rounded-full bg-surface border-2 border-base flex items-center justify-center text-primary-text mb-2 shadow-lg">User</div>
                                    </div>
                    ...
                    <div transition:fade={{duration: 200}}>
                        ...
                        <div class="bg-[#0d1117] rounded-xl border border-rose-500/10 shadow-2xl overflow-hidden font-mono text-xs sm:text-sm ">
                            ...
                            <div class="p-5 space-y-3 text-primary-text h-72 overflow-y-auto custom-scrollbar">
                                ...
                                <p class="text-emerald-400 flex items-center gap-2 mt-6 font-semibold border-t border-subtle pt-4"><span>➜</span> <span class="text-blue-400">curl</span> -H "Authorization: Bearer attacker_token" https://api.target.com/v1/invoices/9402 | jq</p>
                                <div class="pl-4 mt-2">
                                <pre class="text-orange-300 bg-glass p-4 rounded-xl border border-subtle shadow-inner">
&#123;
  "invoice_id": 9402,
