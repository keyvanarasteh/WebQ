...
{#if isOpen}
    ...
    >
        ...
        >
            <!-- Header Area -->
            <div class="relative bg-gradient-to-r from-rose-950/40 via-red-900/10 to-transparent p-6 border-b border-rose-500/10 shrink-0">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative z-10">
                    <div class="flex items-center gap-4">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-rose-500/20 to-red-600/10 flex items-center justify-center border border-rose-500/30 shadow-inner">
            ...
            <div class="flex-1 overflow-y-auto p-6 relative">
                ...
                {:else if activeTab === 1}
                    <div transition:fade={{duration: 200}}>
                        ...
                        <!-- Terminal Mockup -->
                        <div class="bg-[#0d1117] rounded-xl border border-rose-500/10 shadow-2xl overflow-hidden font-mono text-xs sm:text-sm shadow-[0_0_30px_rgba(0,0,0,0.5)]">
