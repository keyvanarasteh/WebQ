...
- [x] Fix the release workflow package-manager mismatch (`tauriScript: npm run tauri` + removed `bun.lock`); see [macOS Release Signing Audit](macos-release-signing-audit.md).
